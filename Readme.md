...
| ------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| <img src="https://github.com/karlhorky/my-favorite-food/blob/main/screenshots/Home.png?raw=true" width="150"> | <img src="https://github.com/karlhorky/my-favorite-food/blob/main/screenshots/Detail.png?raw=true" width="150"> | <img src="https://github.com/karlhorky/my-favorite-food/blob/main/screenshots/New.png?raw=true" width="150"> |
...
- `icon` => `./assets/logo.png` (app icon - [download](https://github.com/karlhorky/my-favorite-food/blob/main/assets/logo.png))
- `splash.backgroundColor` => `#ff9100` (color to fill the loading screen background)
- `web.favicon` => `./assets/logo.png` (web favicon - [download](https://github.com/karlhorky/my-favorite-food/blob/main/assets/logo.png))
...
- use component with local [download](https://github.com/karlhorky/my-favorite-food/blob/main/assets/pizza.jpg) and remote (https://github.com/karlhorky/my-favorite-food/blob/main/assets/pizza.jpg) sources in App.js
